...
def implement_query_model(model, prompt):
    ...
    try:
        # Match professor's LangChain-like message format
        messages = [("human", prompt.strip())]
...
def implement_compare_models(prompt):
    ...
    return {
        llama4.model: implement_query_model(llama4, prompt),
        llama33.model: implement_query_model(llama33, prompt),
    }
